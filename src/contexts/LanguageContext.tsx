...
const translations = {
  fr: {
    ...
    "project.status.blocked": "Bloqué",
    "project.status.archived": "Archivé",
    "project.status.all": "Tous les projets",
    "project.filter.in_progress": "En cours",
    "project.filter.blocked": "Bloqués",
    "project.filter.archived": "Archivés",
    "project.filter.all": "Tous les projets",
    "project.count": "projets",
  },
  en: {
    ...
    "project.filter.blocked": "Blocked",
